...
cor3_filepath = os.getcwd() + "/GISFiles/output/corridor3.gpkg"
...
line2_filepath = os.getcwd() + "/GISFiles/output/best stations2.gpkg"
...
def main():
    ...
    data.update({"avg_fitness3":avg})
    data.update({"max_fitness3":max})
    
    # Output Path for the Best Stations
    output_fp = os.getcwd() + "/GISFiles/output/best stations3.gpkg"
